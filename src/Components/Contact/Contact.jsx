    ...
    <div id="contact" className='contact'>
        ...
        <div className="contact-section">
            <div className="contact-left">
                <h1>Let's Talk</h1>
                <p>I am currently available to take on new project, so feel free to send me a message about anything that you want me to work on. You can contact anytime.</p>
                <div className="contact-details">
                    <div className="contact-detail">
                        <img src={mail_icon} alt="" />
                        <p>bibekkarki718@gmail.com</p>
                    </div>
                    <div className="contact-detail">
                ...
                <div className="social-icons">
                    <a href="mailto:bibekkarki718@gmail.com" target="_blank" className="icon-container">
